...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-21152-harmony/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-21152-harmony/realtime/main_synth.xdc
    rt::sdcChecksum
    set rt::top main
...
# MODE: 
    rt::set_parameter webTalkPath {/media/2TB_Crucial_SSD/repos/vlsi_group_ca02/practical_1_v3/practical_1_v3.cache/wt}
    rt::set_parameter synthDebugLog false
    rt::set_parameter printModuleName false
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-21152-harmony/"
