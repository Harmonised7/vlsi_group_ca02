...
namespace eval ::optrace {
  variable script "/media/2TB_Crucial_SSD/repos/vlsi_group_ca02/practical_1_v3/practical_1_v3.runs/synth_1/GroupBlinkingLed.tcl"
...
read_vhdl -library xil_defaultlib {
  ...
  /media/2TB_Crucial_SSD/repos/vlsi_group_ca02/practical_1_v3/practical_1_v3.srcs/sources_1/new/GroupBlinkingLed.vhd
}
...
synth_design -top GroupBlinkingLed -part xc7a35ticpg236-1L
...
write_checkpoint -force -noxdef GroupBlinkingLed.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file GroupBlinkingLed_utilization_synth.rpt -pb GroupBlinkingLed_utilization_synth.pb"
