...
HD_PWD='/media/2TB_Crucial_SSD/repos/vlsi_group_ca02/totally_the_final_project_time_mhmm_wont_recreate_it_again/totally_the_final_project_time_mhmm_wont_recreate_it_again.runs/impl_1'
cd "$HD_PWD"
